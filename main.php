...
<html lang="en">
    ...
    <body>
        <a class="text_color" href="signup.html">회원가입</a>
        <span style="font-size:large; color:#FF9991">ㅣ</span>
        <a class="text_color" href="login.html">로그인</a>
        ...
        <form name="write_form_member" method="post">
            <table width="940" height="300" style="padding:5px 0 5px 0;" align="center" >
                ...
                <tr>
                    ...
                    <td><center><a onclick="window.alert('로그인 해주세요!'); location.href='login.html'">예약대출서비스 양식을 준수해주세요! (+ 수령일 및 희망도서 안내)</a></center></td>
                ...
                <tr>
                    <td colspan="5" align="right">
                        <input type="button" value="글쓰기" onclick="window.alert('로그인 해주세요!'); location.href='login.html'">
                    </td>
                </tr>
           </table>
